...
CMD mkdir -p database && touch database/database.sqlite && php artisan migrate --force && php artisan key:generate --force && php artisan optimize && php artisan serve --host=0.0.0.0 --port=10000
